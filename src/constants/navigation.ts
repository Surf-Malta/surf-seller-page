// src/constants/navigation.ts - UPDATED VERSION
export const NAVIGATION_ITEMS = [
  {
    id: "sell-online",
    label: "Sell Online",
    href: "/sell-online",
    description: "Start selling your products online",
  },
  {
    id: "how-it-works",
    label: "How it works",
  ...
  {
    id: "no-gst",
    label: "Don't have GST?",
    href: "/no-gst",
    description: "Solutions for non-GST sellers",
  },
] as const;
