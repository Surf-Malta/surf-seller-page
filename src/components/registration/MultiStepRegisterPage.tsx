            ...
            <div className="text-center">
              <div className="ecommerce-card p-12 animate-scale-in">
                ...
                <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
                  Thank you for joining Surf! Your business "{formData.businessName}" has been submitted for review.
                </p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <ul className="text-blue-700 space-y-2">
                        ...
                        <li>🔍 Our team will review your application (usually takes 1-2 business days)</li>
                        <li>🚀 Once approved, you'll get access to the vendor panel to start selling</li>
                        <li>💬 Our support team will contact you with next steps</li>
                      </ul>
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-6xl mx-auto py-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Connect with thousands of customers in Malta and beyond. No setup fees, just simple commission-based pricing.
            </p>
          </div>
            ...
            <div className="space-y-8">
              {currentStep === 1 && (
                <div className="ecommerce-card p-8">
                  ...
                  <p className="text-lg text-gray-600 mb-6">
                    Help us understand your business better so we can provide the best selling experience.
                  </p>
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900">Malta-Based Platform</h4>
                        <p className="text-gray-600 text-sm">Designed specifically for Malta businesses</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900">VAT Compliant</h4>
                        <p className="text-gray-600 text-sm">Full Malta VAT compliance support</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {currentStep === 2 && (
                <div className="ecommerce-card p-8">
                  ...
                  <p className="text-lg text-gray-600 mb-6">
                    We need your contact details for account verification and order management.
                  </p>
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="font-semibold text-yellow-800">Secure & Private</h4>
                        <p className="text-yellow-700 text-sm mt-1">
                          Your information is encrypted and only used for account verification and order processing.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              {currentStep === 3 && (
                <div className="ecommerce-card p-8">
                  ...
                  <p className="text-lg text-gray-600 mb-6">
                    Choose your preferred shipping method to ensure smooth deliveries to your customers.
                  </p>
                  <div className="space-y-4">
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                      <h4 className="font-semibold text-blue-800 mb-2">💡 Pro Tip</h4>
                      <p className="text-blue-700 text-sm">
                        Our integrated shipping partners offer competitive rates and reliable service across Malta and internationally.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {currentStep === 4 && (
                <div className="ecommerce-card p-8">
                  ...
                  <p className="text-lg text-gray-600 mb-6">
                    Increase your product visibility and reach more customers with our advertising options.
                  </p>
            ...
            <div className="ecommerce-card p-10">
              ...
              {currentStep === 1 && (
                <div className="space-y-6">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-3">
                      How did you hear about Surf? <span className="text-red-500">*</span>
                    </label>
                    <select
                      value={formData.hearAboutSurf}
                      onChange={(e) => updateFormData("hearAboutSurf", e.target.value)}
                      className="w-full px-4 py-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                    >
              ...
              {/* Step 2 Form - Contact & Pickup Address */}
              {currentStep === 2 && (
                <div className="space-y-6">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                ...
                <div className="space-y-6">
                  <div className="space-y-4">
                    ...
                    >
                      <div className="flex items-start space-x-4">
                        <input
                          ...
                          onChange={() => updateFormData("shippingMethod", "own")}
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-gray-600 mb-3">
                            Handle shipping yourself with your preferred logistics partner
                          </p>
                    ...
                    <div
                      ...
                      onClick={() => updateFormData("shippingMethod", "integrated")}
                    >
                      <div className="flex items-start space-x-4">
                        <input
                          type="radio"
                          ...
                          onChange={() => updateFormData("shippingMethod", "integrated")}
                          className="mt-2 w-5 h-5 text-blue-600"
                        />
                        <div className="flex-1">
                          <h3 className="text-xl font-bold text-gray-900 mb-2">
                          ...
                          <p className="text-gray-600 mb-3">
                            Let us handle shipping with our verified local partners
                          </p>
                    ...
                    <div className="space-y-6 bg-blue-50 p-6 rounded-xl">
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <button
                            type="button"
                            onClick={() => updateFormData("shippingType", "fixed_rate")}
                            className={`p-4 border-2 rounded-xl transition-all duration-200 ${
                          ...
                          <button
                            type="button"
                            onClick={() => updateFormData("shippingType", "free_delivery")}
                            className={`p-4 border-2 rounded-xl transition-all duration-200 ${
                        ...
                        <div className="grid grid-cols-3 gap-3">
                          {[
                            ...
                            <button
                              key={option.value}
                              type="button"
                              onClick={() => updateFormData("deliveryTime", option.value as any)}
                ...
                <div className="space-y-6">
                  <div className="bg-gradient-to-br from-purple-50 to-blue-50 border-2 border-purple-200 rounded-xl p-8">
                    ...
                    <div className="flex items-center justify-between p-4 bg-white rounded-lg border border-purple-200">
                      <div className="flex-1">
                        <h4 className="font-semibold text-gray-900 mb-2">Show ads on website</h4>
                        <p className="text-gray-600 text-sm">
                          Increase your product visibility with sponsored listings
                        </p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer ml-4">
                        <input
                          ...
                          onChange={(e) => updateFormData("showAdsOnWebsite", e.target.checked)}
                      ...
                      <div className="mt-4 p-4 bg-purple-100 rounded-lg">
                        <div className="flex items-center text-purple-800">
                          ...
                          <span className="text-sm font-medium">
                            Great choice! Your products will get priority placement in search results.
                          </span>
                        </div>
                      </div>
                    )}
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-xl p-6">
                    <h4 className="font-bold text-green-800 mb-2">🎯 Ready to Launch!</h4>
                    <p className="text-green-700 text-sm">
                      You're all set! Click submit to complete your registration and start your selling journey with Surf.
                    </p>
                  </div>
                </div>
              )}
