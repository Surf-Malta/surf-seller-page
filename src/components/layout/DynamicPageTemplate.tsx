...
export default function DynamicPageTemplate({
  ...
  useEffect(() => {
    ...
    try {
      // Fetch navigation items to find the current page
  ...
  // If no content from Firebase but we have fallback content, show that
  if (pageContent.length === 0 && fallbackContent) {
    return (
      <div className="min-h-screen bg-white py-20">
        <Container>
      ...
      <div className="min-h-screen bg-white py-20">
        <Container>
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              This page doesn't have any content yet. Please check back later or
              contact support.
            </p>
            <Link href="/">
